...
- Proactive loop: scheduler ticks every minute; fires proactive check-ins based on `autorun_interval` (1m/2m/5m/1h/2h/5h). Cron stub not implemented yet. Default interval is 1h.
